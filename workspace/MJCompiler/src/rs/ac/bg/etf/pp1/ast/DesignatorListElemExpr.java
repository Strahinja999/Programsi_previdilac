...
public class DesignatorListElemExpr extends Designator {

    private DesignatorHelper DesignatorHelper;
    private Expr Expr;

    public DesignatorListElemExpr (DesignatorHelper DesignatorHelper, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorListElemExpr(\n");
